  ...
  return (
    <footer className={style.footer}>
      ...
      <div className={style.social_media}>
        <div>
          <a href="#">
            <BsGithub className={`${style.media_icon} ${style.github_icon}`} />
          </a>
        </div>
        <div>
          <a href="#">
            <BsLinkedin
              className={`${style.media_icon} ${style.linkedin_icon}`}
            />
          </a>
        </div>
        <div>
          <a href="#">
            <BsEnvelope className={`${style.media_icon} ${style.gmail_icon}`} />
          </a>
        </div>
      </div>
